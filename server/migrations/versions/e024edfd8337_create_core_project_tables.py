...
Revision ID: e024edfd8337
Revises: 49b5354399ea
Create Date: 2026-09-18 17:32:44.919513
...
revision: str = 'e024edfd8337'
down_revision: Union[str, Sequence[str], None] = '49b5354399ea'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_site_metrics_site_id'), 'site_metrics', ['site_id'], unique=False)    # ### end Alembic commands ###
...
def downgrade() -> None:
    ...
    op.drop_index('idx_sites_boundary', table_name='sites', postgresql_using='gist')
    op.drop_table('sites')
